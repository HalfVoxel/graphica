use wgpu::{Device, CommandEncoder, Buffer};
...
pub fn create_buffer_via_transfer<'a, T>(device: &Device, encoder: &mut CommandEncoder, v: &[T], usage: wgpu::BufferUsage, label: impl Into<Option<&'a str>>) -> (Buffer, u64) {
